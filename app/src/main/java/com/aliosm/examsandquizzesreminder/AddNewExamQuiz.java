...
public class AddNewExamQuiz extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_new_exam_quiz);
        ...
        addNewExamQuizBtn = findViewById(R.id.addNewExamQuizBtn);
        ...
        setIcon(getString(R.string.plus), getString(R.string.add_new_exam), font, addNewExamQuizBtn);
    }
    ...
    public void quizRbClick(View view) {
        ...
        setIcon(getString(R.string.plus), getString(R.string.add_new_quiz), font, addNewExamQuizBtn);
    }
    ...
    public void pickTimeBtnClick(View view) {
        if(dateEt.getText().toString().equals(getString(R.string.yyyy_mm_dd))) {
            Toast.makeText(this, "Pick a date before picking the time", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void addNewExamQuizBtnClick(View view) throws ParseException {
        ...
        db.addNewExamQuiz(type, name, date, time);

        // START SET ALARM
        String curId = db.getLastId();

        Context context = getApplicationContext();
        AlarmManager am = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
        Intent serviceIntent = new Intent(context, NotifyExamsAndQuizzes.class);
        serviceIntent.putExtra("id", curId);

        PendingIntent servicePendingIntent =
                PendingIntent.getService(context,
                        Integer.valueOf(curId),
                        serviceIntent,
        ...
        am.set(AlarmManager.RTC_WAKEUP, dateBefore.getTime(), servicePendingIntent);
        // END SET ALARM
